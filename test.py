...
# token = 'EAAAAZAw4FxQIBAJFt3ICvXrQXpIWxJDuiFHiEKI90olrQAvDPrcwtcDQ5PWP4mB9CSthmaJLXjkB5RmwPnGrpXZBukBZBZAchzxiElphJSyl94bkZCqlEqFPbBIzflh593VD0OQy8H5ZBxGRYWbRUC1qXQqZCOv1ZCPvXt1FHlZAbIwZDZD'
...
# url = 'https://graph.facebook.com/100053309799241/photos?fields=id'
# res = requests.get(url, params=params)
# data = res.json()
# print(data)